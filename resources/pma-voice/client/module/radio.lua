	...
	if not radioPressed and radioEnabled then
		if radioChannel > 0 then
			...
			if GetConvarInt('voice_enableRadioAnim', 0) == 1 and
				...
				if exports["core"]:GetJobPlayer() == "lspd" or exports["core"]:GetJobPlayer() == "ems" or exports["core"]:GetJobPlayer() == "lsfd" or exports["core"]:GetJobPlayer() == "bp" or exports["core"]:GetJobPlayer() == "g6" or exports["core"]:GetJobPlayer() == "usmc" or exports["core"]:GetJobPlayer() == "lssd" then
					ExecuteCommand("e copradio")
				elseif exports["core"]:GetJobPlayer() == "usss" then
					ExecuteCommand("e secretservice2")
				else
...
RegisterCommand('-radiotalk', function()
	if (radioChannel > 0 or radioEnabled) and radioPressed then
		...
		if GetConvarInt('voice_enableRadioAnim', 0) == 1 then
            if exports["core"]:GetJobPlayer() == "lspd" or exports["core"]:GetJobPlayer() == "ems" or exports["core"]:GetJobPlayer() == "g6" or exports["core"]:GetJobPlayer() == "usmc" or exports["core"]:GetJobPlayer() == "lsfd" or exports["core"]:GetJobPlayer() == "bp" or exports["core"]:GetJobPlayer() == "lssd" then
				StopAnimTask(PlayerPedId(), "copradio@animation", "copradio_clip", -4.0)
				ExecuteCommand("e c")
			elseif exports["core"]:GetJobPlayer() == "usss" then
				StopAnimTask(PlayerPedId(), "wristmic@animation", "wristmic4_clip", -4.0)
				ExecuteCommand("e c")
			else
