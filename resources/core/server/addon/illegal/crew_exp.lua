...
--     ["VANCE CRIME FAMILY"] = {id = 8},
--     ["Famille Guevara"] = {id = 9},
--     ["Mafia Française"] = {id = 48},
--     ["Famille Chapelier"] = {id = 52},
--     ["La Corporation"] = {id = 55},
--     ["Mcreary Crime Family"] = {id = 58},
--     --orga
--     ["Wonderland"] = {id = 10},
...
--     ["Vinewood Boyz"] = {id = 46},
--     ["J-Money"] = {id = 56},
--     ["Black Disciple Nation"] = {id = 50},
--     ["EASTSIDE PLAYBOYS"] = {id = 54},
--     ["NGG's"] = {id = 57},
--     ["Blow in Tack "] = {id = 62},
-- }
