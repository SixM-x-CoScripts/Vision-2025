...
--[[
    DeferralCards.CardElement:Media({
        poster = 'https://adaptivecards.io/content/poster-video.webp',
        sources = {}
    })
]]
...
function DeferralCards.Container.ImageSetItem(self, pOptions)
    ...
    pOptions.url = pOptions.url or 'https://adaptivecards.io/content/cats/1.webp'
    return pOptions
end
--[[
    DeferralCards.Container:ImageSetItem({
        type = 'Image',
        url = 'https://adaptivecards.io/content/cats/1.webp'
    })
]]
...
--[[
    DeferralCards.Container:ImageSet({
        images = {
            ...
            DeferralCards.Container:ImageSetItem({
                type = 'Image',
                url = 'https://adaptivecards.io/content/cats/2.webp'
            })
        }
    })
]]
