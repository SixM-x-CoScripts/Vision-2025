...
local vehSpawnPos = {
    vector4(700.49, -1362.79, 24.25, 275.79),
    vector4(700.72, -1365.84, 24.39, 276.78),
    vector4(701.05, -1369.29, 24.6, 279.71),
}
...
CreateThread(function()
    ...
    local pedsData = {
        { model = "s_m_m_armoured_02", position = vector3(710.43, -1377.63, 25.24), heading = 62.92, scenario = "WORLD_HUMAN_CLIPBOARD" },
    }
...
function LoadG6Job()
    local casierPos = {
        vector3(738.05, -1375.76, 26.11), 
    }

    local armureriePos = vector3(737.64, -1361.86, 26.12)
    local garagePos = vector4(701.48, -1376.79, 25.19, 279.92)
    local customVehPos = vector3(714.06, -1352.69, 25.62)
    local garagePedPos = vector3(710.08, -1377.95, 26.25) 
    local societyPos = vector3(751.97, -1397.87, 27.12) 
    local stockagePos = vector3(748.23, -1392.76, 27.12) 
    local vestiairePos = vector3(740.16, -1394.07, 27.11) 

    local vehicleOut = nil
    local currentVeh = nil

    local items = {
        headerImage = "https://cdn.sacul.cloud/v2/vision-cdn/Armurerie/Banners/G6.webp",
        headerIcon = 'https://cdn.sacul.cloud/v2/vision-cdn/Armurerie/Banners/icon.webp',
        headerIconName = 'CATALOGUE',
        callbackName = 'armoryTakeG6',
    ...
    function G6Announce()
        if g6Duty then
            ...
            if annonce ~= "" and type(annonce) == "string" then
                TriggerServerEvent("core:makeAnnounceG6", token, annonce)
            else
    ...
    zone.addZone("g6_item", armureriePos,
    ...
    zone.addZone("g6_garage", vector3(garagePos.x, garagePos.y, garagePos.z),
    ...
    zone.addZone("society_g6_custom", customVehPos,
    ...
    zone.addZone("g6_garage_vehicle", garagePedPos,
    ...
    zone.addZone("society_g6", societyPos,
    ...
    zone.addZone("stockage_g6", stockagePos,
        "Appuyer sur ~INPUT_CONTEXT~ pour ouvrir le stockage G6", function()
    ...
    zone.addZone("vestiaire_g6", vestiairePos,
        "Appuyer sur ~INPUT_CONTEXT~ pour prendre une tenue", function()
            LoadVestiaireG6() -- TODO: fini le menu society
        end, false,
        27,
        0.5,
        { 255, 255, 255 },
    ...
    for k, v in pairs(casierPos) do
        zone.addZone("coffre_g6" .. k, v, "Appuyer sur ~INPUT_CONTEXT~ pour ouvrir les casiers",
            function()
    ...
    local g6menu_traffic_add = RageUI.CreateSubMenu(g6menu_traffic, "", "g6", 0.0, 0.0, "vision", "menu_title_g6")
    local g6menu_traffic_view = RageUI.CreateSubMenu(g6menu_traffic, "", "g6", 0.0, 0.0, "vision", "menu_title_g6")
    local g6menu_objects_delete = RageUI.CreateSubMenu(g6menu_objects, "", "g6", 0.0, 0.0, "vision", "menu_title_g6")
                    ...
                    while open do
                        RageUI.IsVisible(g6menu_traffic, function()
                            ...
                            RageUI.Button("Voir les zones", nil, {
                                ...
                                onSelected = function()
                                    traficList = TriggerServerCallback("g6:traffic:get")
                                end
                            }, g6menu_traffic_view)
                        end)
                            ...
                            RageUI.Button("Ajouter la zone", nil, {}, true, {
                                onSelected = function()
                                    if radius ~= 0 and zoneName ~= "" then
                                        ...
                                        show = false
                                        TriggerServerEvent("g6:traffic:add", newZone)
                            ...
                            for k, v in pairs(traficList) do
                                RageUI.Button(v.zoneId .. " | " .. v.zoneName, nil, {
                                    ...
                                    onSelected = function()
                                        ...
                                        TriggerServerEvent("g6:traffic:remove", v.zoneId)
    ...
    function makeRenfortCall()
        if g6Duty then
            TriggerSecurEvent('core:makeCall', "g6", p:pos(), false,
                "Appel de renfort (" .. p:getLastname() .. " " .. p:getFirstname() .. ")")
            ExecuteCommand("me fait un appel de renfort")
            -- p:PlayAnim('amb@code_human_g6_investigate@idle_a', 'idle_b', 51)
            openRadial = false
            closeUI()
    ...
    local oldSkin = {}
    local open = false
    local outifitmenu = RageUI.CreateMenu("", "g6", 0.0, 0.0, "vision", "menu_title_g6")
    local outfitmenu_list = RageUI.CreateSubMenu(outifitmenu, "", "g6", 0.0, 0.0, "vision", "menu_title_g6")
    ...
    function enterInGarage()
        ...
        zone.addZone("g6_garage_exit", vector3(1295.2905273438, 217.6827545166, -49.055416107178),
    ...
    local open = false
    local g6garage_main = RageUI.CreateMenu("", "g6", 0.0, 0.0, "vision", "menu_title_g6")
    local g6garage_vehicle =
        RageUI.CreateSubMenu(g6garage_main, "", "g6", 0.0, 0.0, "vision", "menu_title_g6")
    g6garage_main.Closed = function()
        open = false
    end
    ...
    local listVeh = {
        ...
        callbackName = 'Menu_G6_vehicule_callback',
        elements = {
            {
                label = 'Stanier',
                spawnName = 'g6stanier',
                image = "https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6stanier.webp",
                category = "Patrol",
                subCategory = 'Security Trainee'
            },
            {
                label = 'Scout',
                spawnName = 'g6scout3',
                image = "https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6scout3.webp",
                category = "Patrol",
                subCategory = 'Security Agent'
            },
            {
                label = 'Fugitive',
                spawnName = 'g6fugitive',
                image = "https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6fugitive.webp",
                category = "Patrol",
                subCategory = 'Security Sergeant'
            },
            {
                label = 'Alamo',
                spawnName = 'g6alamo2',
                image = "https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6alamo2.webp",
                category = "Patrol",
                subCategory = 'Security Sergeant'
            },
            {
                label = 'Buffalo Sport',
                spawnName = 'g6buffalo4',
                image = "https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6buffalo4.webp",
                category = "Patrol",
                subCategory = 'Supervision'
            },
            {
                label = 'Buffalo STX',
                spawnName = 'g6buffalo5',
                image = "https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6buffalo5.webp",
                category = "Patrol",
            ...
            },
            {
                label = 'Stockade',
                spawnName = 'stockade',
                image = "https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/stockade.webp",
                category = "Utility",
            },
            {
                label = 'Buffalo Diamond Casino',
                spawnName = 'g6buffalo6',
                image = "https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6buffalo6.webp",
                category = "Utility",
            },
            {
                label = 'Scout Diamond Casino',
                spawnName = 'g6scout5',
                image = "https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6scout5.webp",
                category = "Utility",
            },
            {
                label = 'Alamo Diamond Casino',
                spawnName = 'g6alamo4',
                image = "https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6alamo4.webp",
                category = "Utility",
            },
			...
			{
				image = 'https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6bison2.webp',
				label = 'Bison G6',
				spawnName = "g6bison",
				subCategory = 'ROOKIE'
			},
			{
				image = 'https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6buffalo2.webp',
				label = 'Bufallo G6',
				spawnName = "g6buffalo2",
				subCategory = 'ROOKIE'
			},
			{
				image = 'https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6fugitive.webp',
			...
			{
				image = 'https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6scout2.webp',
				label = 'Scout G6',
				spawnName = "g6scout2",
				subCategory = 'ROOKIE'
			},
			...
			{
				image = 'https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6torrence.webp',
				label = 'Torrence G6',
				spawnName = "g6torrence",
				subCategory = 'ROOKIE'
			},
			{
				image = 'https://cdn.sacul.cloud/v2/vision-cdn/Entreprise/G6/g6torrence2.webp',
				label = 'Torrence G6',
				spawnName = "g6torrence2",
				subCategory = 'ROOKIE'
			}, ]]
        }
    }
    ...
    RegisterNetEvent("core:g6GetVehGarage")
    AddEventHandler("core:g6GetVehGarage", function(data)
        allVehicleList = data
    end)

    RegisterNetEvent("core:g6SpawnVehicle")
    AddEventHandler("core:g6SpawnVehicle", function(data)
        currentVeh = data
    ...
    local function GetDatasProps()
        -- DataSendPropsG6.items.elements = {}

        local playerJobs = 'g6-lssd'

        -- Cones
        for i = 1, 10 do
            table.insert(DataSendPropsG6.items[2].elements, {
                id = i,
        ...
        -- Panneaux
        for i = 1, 8 do
            table.insert(DataSendPropsG6.items[3].elements, {
                id = i,
                image = "https://cdn.sacul.cloud/v2/vision-cdn/PropsMenu/" ..
        ...
        -- Barrière
        for i = 1, 11 do
            table.insert(DataSendPropsG6.items[4].elements, {
                id = i,
                image = "https://cdn.sacul.cloud/v2/vision-cdn/PropsMenu/" ..
        ...
        -- Lumières
        for i = 1, 5 do
            table.insert(DataSendPropsG6.items[5].elements, {
                id = i,
                image = "https://cdn.sacul.cloud/v2/vision-cdn/PropsMenu/" ..
        ...
        -- Tables
        for i = 1, 2 do
            table.insert(DataSendPropsG6.items[6].elements, {
                id = i,
                image = "https://cdn.sacul.cloud/v2/vision-cdn/PropsMenu/" ..
        ...
        -- Drogues
        for i = 1, 9 do
            table.insert(DataSendPropsG6.items[7].elements, {
                id = i,
                image = "https://cdn.sacul.cloud/v2/vision-cdn/PropsMenu/" ..
        ...
        -- Divers
        for i = 1, 4 do
            table.insert(DataSendPropsG6.items[8].elements, {
                id = i,
                image = "https://cdn.sacul.cloud/v2/vision-cdn/PropsMenu/" ..
        ...
        -- Cible Tir
        for i = 1, 2 do
            table.insert(DataSendPropsG6.items[9].elements, {
                id = i,
                image = "https://cdn.sacul.cloud/v2/vision-cdn/PropsMenu/" ..
        ...
        -- Sacs
        for i = 1, 2 do
            table.insert(DataSendPropsG6.items[10].elements, {
                id = i,
                image = "https://cdn.sacul.cloud/v2/vision-cdn/PropsMenu/" ..
        ...
        DataSendPropsG6.disableSubmit = true
    ...
    DataSendPropsG6 = {
        ...
        headerImage = 'https://cdn.sacul.cloud/v2/vision-cdn/headers/header_g6.webp',
        callbackName = 'MenuObjetsServicesPublicsG6',
    ...
    OpenPropsMenuG6 = function()
        ...
        SendNuiMessage(json.encode({
            ...
            data = DataSendPropsG6
        }))
    end
end

function UnloadG6Job()
    zone.removeZone("coffre_g6")
    zone.removeZone("g6Outfit")
    zone.removeZone("police_garage")
    zone.removeZone("society_g6")
    zone.removeZone("stockage_g6")
    zone.removeZone("stockage_g62")
...
RegisterNUICallback("Menu_G6_vehicule_callback", function(data, cb)
    for key, value in pairs(vehSpawnPos) do
        if vehicle.IsSpawnPointClear(vector3(value.x, value.y, value.z), 3.0) then
            ...
            if data.spawnName == "g6buffalo6" then
                SetVehicleLivery(vehs, 6)
            elseif data.spawnName == 'g6scout5' then
                SetVehicleLivery(vehs, 3)
            elseif data.spawnName == 'g6alamo4' then
                SetVehicleLivery(vehs, 6)
            end
...
RegisterNUICallback("armoryTakeG6", function(data, cb)
...
local function SpawnPropsG6(obj, name)
...
RegisterNUICallback("MenuObjetsServicesPublicsG6", function(data, cb)
    ...
    if data.category == "Cones" then
        SpawnPropsG6(cones_models[data.label], data.label)
    end

    if data.category == "Panneaux" then
        SpawnPropsG6(panneaux_models[data.label], data.label)
    end

    if data.category == "Barrières" then
        SpawnPropsG6(barriere_models[data.label], data.label)
    end

    if data.category == "Lumières" then
        SpawnPropsG6(lumiere_models[data.label], data.label)
    end

    if data.category == "Tables" then
        SpawnPropsG6(tables_models[data.label], data.label)
    end

    if data.category == "Drogues" then
        SpawnPropsG6(drogues_models[data.label], data.label)
    end

    if data.category == "Divers" then
        SpawnPropsG6(divers_models[data.label], data.label)
    end

    if data.category == "Cibles Tir" then
        SpawnPropsG6(cibletir_models[data.label], data.label)
    end

    if data.category == "Sacs" then
        SpawnPropsG6(sacs_models[data.label], data.label)
    end
end)

RegisterNetEvent("g6:traffic:addclient", function(zone)
    AddRoadNodeSpeedZone(zone.zonePos, zone.zoneRadius, zone.zoneSpeed, true)
end)

RegisterNetEvent("g6:traffic:removeclient", function(zone)
    RemoveRoadNodeSpeedZone(zone)
end)

Citizen.CreateThread(function()
    while p == nil do Wait(1000) end
    print("^3[JOBS]: ^7g6 ^3loaded")
end)
