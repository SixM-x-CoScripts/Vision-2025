local dogBreeds = { 'Rottweiler', 'Husky', 'Retriever', 'Shepherd', 'Berger', 'Berger 2', 'Berger LSFD', 'Berger Civil', 'Berger Civil 2'}
local dogBHash = { 'a_c_rottweiler', 'a_c_husky', 'a_c_retriever', 'a_c_shepherd', 'a_c_berger', 'a_c_berger1', 'a_c_bergerlsfd',
    'a_c_bergerciv', 'A_C_BergerCiv1'}
                            ...
                            onSelected = function()
                                ...
                                if k91Name == nil then
                                    ...
                                    exports['vNotif']:createNotification({
                                        ...
                                        content = "Vous devez ~s donner un nom ~c au chien !"
                                    })
                                    ...
                                    SetBlockingOfNonTemporaryEvents(k91, true)
                                    ...
                                    SetPedCombatAttributes(k91, 58, true)
...
function attackK9(ped)
    ...
    local player = GetAllPlayersInArea(p:pos(), 10.0)
...
function Command_Follow(ped)
    ...
    TaskFollowToOffsetOfEntity(ped, PlayerPedId(), 0.5, 0.0, 0.0, 7.0, -1, 0.2, true)
...
CreateThread(function()
    ...
    if p:getJob() == 'lspd' or p:getJob() == 'lssd' or p:getJob() == 'lsfd' or p:getJob() == 'gcp' then
        Keys.Register('$', '$', 'Menu K9', function()
            if p:getJob() == 'lspd' or p:getJob() == 'lssd' or p:getJob() == 'lsfd' or p:getJob() == 'gcp' then
                openK9Menu()
            else
                RemoveBlip(blipk91)
