CreateThread(function()
    ...
    local pedsData = {
        { model = "s_m_m_fiboffice_02", position = vector3(-410.58, 6168.47, 30.48), heading = 320.75 },
    }
...
function LoadGouvJob2()
    ...
    zone.addZone(
        "gouv_delete",
        vector3(-434.18, 6138.21, 31.48), --570.53234863281, -145.54238891602, 37.778263092041
    ...
    zone.addZone(
        "society_gouv",
        vector3(-436.78, 6150.04, 32.31), --544.36950683594, -199.47077941895, 47.54615020752
    ...
    zone.addZone(
        "coffre_gouv2",
        vector3(-432.42, 6145.55, 32.31), --552.38275146484, -197.94941711426, 47.54615020752
        "Appuyer sur ~INPUT_CONTEXT~ pour ouvrir le coffre de l'entreprise",
        function()
            OpenInventorySocietyMenu() --TODO: fini le menu society
        end, false,
    ...
    zone.addZone("casier_gouv", vector3(-416.17, 6142.65, 32.31), ---567.16662597656, -195.13107299805, 38.219741821289
    ...
    zone.addZone(
        "spawn_gouv",
        vector3(-410.58, 6168.47, 32.48), ---583.06512451172, -146.10768127441, 37.230884552002
...
RegisterNUICallback("vehMenuGouv", function(data, cb)
    if vehicle.IsSpawnPointClear(vector3(-412.03, 6173.71, 30.486), 3.0) then ---575.73504638672, -149.74160766602, 37.941028594971
        RageUI.CloseAll()
        open = false
        ...
        vehs = vehicle.create(data.name,
            vector4(-412.03, 6173.71, 30.48, 353.07467651367), ---575.73504638672, -149.74160766602, 37.941028594971, 205.38610839844
            {})
...
Citizen.CreateThread(function()
    ...
    print("^3[JOBS]: ^7Gouvernement nord ^3loaded")
end)
