...
local function DumpArray(obj, seen)
...
local PChannels = { -- These channels are default channels and cannot be overriden.
    {name = "Twitch", url = "twitch.tv/twitch"},
    {name = "Youtube", url = "youtube.tv/youtube"},
}

Channels = DumpArray(PChannels)