...
Config = {
    ...
    MenuImage = "https://assets-vision-fa.cdn.purplemaze.net/assets/Headers/banner_animation.jpg", ----[Custom banner IMGUR or GIPHY URLs go here ]---
