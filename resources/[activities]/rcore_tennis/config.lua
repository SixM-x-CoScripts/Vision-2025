...
Config = {
    ...
    BallElasticity = 1.2,
    Tutorial = {
        {text = 'La partie ~y~commence~s~ quand deux joueurs ~y~ont rejoint~s~, un de chaque côté.', time = 5000},
        {text = 'Pour servir, ~y~allez au point~s~, appuyez sur ~y~E~s~ pour commencer à servir.', time = 5000},
        {text = 'Lorsque vous servez, ~y~allez où vous voulez servir~s~ et ~y~appuyez sur le clic gauche~s~', time = 5000},
        {text = '~y~Sélectionnez la puissance~s~ avec laquelle vous voulez servir et utilisez ~y~ZQSD~s~ pour viser où vous voulez tirer.', time = 5000},
        {text = 'Au moment de servir, ~y~visez toujours la diagonale~s~, utilisez donc les touches ~y~Q~s~ ou ~y~ZQ~s~.', time = 5000},
        {text = "Avant de ~y~renvoyer la balle~s~, il est plus facile d'attendre qu'elle ~y~rebondisse ~s~ sur le sol.", time = 5000},
        {text = "~y~Bottom spin~s~ portera la balle ~y~plus loin~s~, ~y~top spin~s~ portera la balle ~y~moins~s~.", time = 5000},
    },
    Translation = {
        SECOND_SERVE = 'Deuxième service',
        OPPONENT_WON_POINT = '~r~L\' adversaire marque un point!',
        YOU_WON_POINT = '~g~Vous marquez un point!',
        OPPONENT_WON_GAME = '~r~L\'adversaire a remporté la partie!',
        YOU_WON_GAME = '~g~Vous avez remporté la partie!',
        ...
        SERVE_HINT = 'Pour servir correctement, visez avec la touche ~y~~Q~~s~ pour toucher le rectangle ~g~surligné~s~.~n~La balle doit ~y~toucher le sol~s~ avant que l\'adversaire puisse la renvoyer.~n~~ y~CLIC GAUCHE~s~ pour servir.',
        SERVE_HINT_AW = 'Q or ZQ',
        SERVE_HINT_DW = 'D or ZD',
        Blip = 'Tennis',
    },
    Control = {
        AIM_FAR = {
