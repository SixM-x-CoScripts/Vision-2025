...
-- all strings
Cfg.strings = {
    noAccessError   = "[ERREUR] CinematicCam : Au moins une des valeurs suivantes doit être vraie ! CinematicCam.useButton, CinematicCam.useCommand",
    wrongUIError    = "[ERREUR] CinematicCam : Ne spécifiez qu'une seule interface utilisateur dans le fichier de configuration !",

    menuTitle       = "Caméra",
    menuSubtitle    = "Contrôlez la caméra cinématique",

    toggleCam       = "Caméra active",
    toggleCamDesc   = "Activer/désactiver la caméra",

    precision       = "Précision de la caméra",
    precisionDesc   = "Modifier le mouvement de précision de la caméra",

    filter          = "Filtre",
    filterDesc      = "Changer le filtre de la caméra",

    filterInten     = "Intensité du filtre",
    filterIntenDesc = "Modifier l'intensité du filtre de la caméra",
    
    delFilter       = "Réinitialiser le filtre",
    delFilterDesc   = "Supprimer le filtre et réinitialiser les valeurs",

    showMap         = "Afficher la mini-carte",
    showMapDesc     = "Activer/désactiver la mini-carte",

    freeFly         = "Activer le mode vol libre",
    freeFlyDesc     = "Passer en mode vol libre ou revenir en mode drone",

    charControl     = "Activer le contrôle du personnage",
    charControlDesc = "Passer au contrôle du personnage ou revenir au contrôle de la caméra",

    attachCam       = "Attacher la caméra à : ",
    attachCamDesc   = "Attacher la caméra à une entité devant elle",

    pointEntity     = "Pointer la caméra vers l'entité",
    pointEntityDesc = "Activer/désactiver le pointage vers l'entité sélectionnée",

    ctrlHelpRoll    = "Rouler à gauche/droite",
